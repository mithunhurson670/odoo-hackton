...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fleet, driver, trip and maintenance operations for modern logistics teams." },
      { property: "og:title", content: "TransitOps — Smart Transport Operations Platform" },
      { property: "og:description", content: "Fleet, driver, trip and maintenance operations for modern logistics teams." },
